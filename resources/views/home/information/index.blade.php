        ...
        <div class="profile-container">
          ...
          <div class="avatar-container">
            <div class="avatar-content">
              <img class="J-setted-avatar" src="./asd/img.meituan.net/maoyanuser/675d3a8bbe27febcf1ccd8c2a25d891210399.png">
          ...
          <form id="J-userexinfo-form" class="userexinfo-form">
            <div class="userexinfo-form-section">
              ...
              <span>
              <input type="text" name="nickName" id="userexinfo-form-nickname" class="ui-checkbox" placeholder="2-15个字，支持中英文、数字" value="陈38653">
              </span>
            </div>
            <div class="userexinfo-form-section">
              <p>
        ...
        <div class="img-cropper-content">
          <div class="img-main">
            <div class="img-main-wrapper">
              <img src="./asd/img.meituan.net/maoyanuser/675d3a8bbe27febcf1ccd8c2a25d891210399.png">
            </div>
          </div>
