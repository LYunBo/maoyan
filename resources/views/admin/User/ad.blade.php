...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 广告栏 <span class="c-gray en">&gt;</span> 广告列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<div class="page-container">
	...
	<a href="/ad/create" class="btn btn-primary radius"><i class="Hui-iconfont"></i> 添加广告</a></span>  
	</div>
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			...
			@foreach($ad as $row)
				<tr class="text-c">
					...
					<td>{{$row->id}}</td>
					<td class="text-l">{{$row->ad_name}}</td>
					<td>{{$row->phone}}</td>
					<td>{{$row->title}}</td>
					...
					<td class="f-14 td-manage">
						...
						@if($row->state==1)
							@if($row->look==0)
								<a style="text-decoration:none" onClick="article_start(this,{{$row->id}})" href="javascript:;" title="上架"><i class="Hui-iconfont" style="font-size: 25">&#xe6dc;</i></a>
							@else
						...
						@endif
						 ...
						 <!-- 编辑 -->
						 <a title="编辑" href="/ad/{{$row->id}}/edit" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont" style="font-size: 25">&#xe6df;</i></a>
...
function article_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		...
		$.get('/ad_lookdel',{'id':id},function(data){
			// alert(data);
			if(data==1){
...
function article_shenhe(obj,id,state){
	...
	function(){
		...
		$.get('/ad_pass',{'id':id,'state':state},function(data){
			if(data==1){
	...
	function(){
    	...
    	$.get('/ad_nopass',{'id':id,'state':state},function(data){
    		if(data==1){
...
function article_stop(obj,id){
	layer.confirm('确认要下架吗？',function(index){
		$.get('/ad_lookdown',{'id':id},function(data){
			if(data==1){
				$(obj).parents("tr").find(".td-manage").prepend('<a style="text-decoration:none" onClick="article_start(this,'+id+')" href="javascript:;" title="上架"><i class="Hui-iconfont" style="font-size: 25">&#xe6dc;</i></a>');
				$(obj).parents("tr").find(".td-status").last().html('<span class="label label-danger radius">已下架</span>');
				$(obj).remove();
...
function article_start(obj,id){
	layer.confirm('确认要上架吗？',function(index){
		// alert(id);
		$.get('/ad_lookup',{'id':id},function(data){
			// alert(data);
			if(data==1){
