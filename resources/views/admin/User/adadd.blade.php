...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 广告栏 <span class="c-gray en">&gt;</span> 添加广告 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="/ad" title="返回" ><i class="Hui-iconfont">&#xe66b;</i></a>
</nav>
<body>
@if(count($errors)>0)
