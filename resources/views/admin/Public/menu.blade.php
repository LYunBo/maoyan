<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="/adminusers" data-title="会员列表" href="javascript:;">会员列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-picture">
		...
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a data-href="/imgss" data-title="图集管理" href="javascript:void(0)">图集列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-comments">
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					...
					<li><a data-href="/adminfilmcinema/create" data-title="添加电影院" href="javascript:void(0)">添加电影院</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-admin">
		...
		<dl id="menu-admin">
            ...
            <dd>
                <ul>
                    <li><a data-href="/url" data-title="链接" href="javascript:void(0)">链接列表</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-admin">
            <dt><i class="Hui-iconfont">&#xe720;</i> 广告栏<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
                    <li><a data-href="/ad" data-title="广告" href="javascript:void(0)">广告列表</a></li>
                </ul>
            </dd>
        </dl>
	</div>
